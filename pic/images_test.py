...
try:
  ...
  # Flags
    ...
    parser.add_argument("--image_path", default="D:\\BaiduNetdiskDownload\\openpose1\\examples\\media\\sss.jpg", help="Process an image. Read all standard formats (jpg, png, bmp, etc.).")
